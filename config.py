...
OWNER_USERNAME = getenv("OWNER_USERNAME","yourdaddysparsh")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Developer_Services")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+rqMonsiap8llYjc1")
